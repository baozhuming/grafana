...
const rangeOptions: TimeOption[] = [
  ...
  { from: 'now-2d', to: 'now', display: '最近两天' },
  ...
  { from: 'now/fQ', to: 'now', display: '本财季到目前为止' },
  { from: 'now/fQ', to: 'now/fQ', display: '本财政季度' },
  { from: 'now/fy', to: 'now', display: '本财年到目前为止' },
  { from: 'now/fy', to: 'now/fy', display: '本财政年度' },
];

const hiddenRangeOptions: TimeOption[] = [
  { from: 'now', to: 'now+1m', display: '下一分钟' },
  { from: 'now', to: 'now+5m', display: '接下来的5分钟' },
  { from: 'now', to: 'now+15m', display: '接下来的15分钟' },
  { from: 'now', to: 'now+30m', display: '接下来的30分钟' },
  { from: 'now', to: 'now+1h', display: '接下来的1个小时' },
  { from: 'now', to: 'now+3h', display: '接下来的3个小时' },
  { from: 'now', to: 'now+6h', display: '接下来的6个小时' },
  { from: 'now', to: 'now+12h', display: '接下来的12个小时' },
  { from: 'now', to: 'now+24h', display: '接下来的24个小时' },
  { from: 'now', to: 'now+2d', display: '接下来的两天' },
  { from: 'now', to: 'now+7d', display: '接下来的7天' },
  { from: 'now', to: 'now+30d', display: '接下来的30天' },
  { from: 'now', to: 'now+90d', display: '接下来的90天' },
  { from: 'now', to: 'now+6M', display: '接下来的6个月' },
  { from: 'now', to: 'now+1y', display: '下一年' },
  { from: 'now', to: 'now+2y', display: '接下来的两年' },
  { from: 'now', to: 'now+5y', display: '接下来的5年' },
];
